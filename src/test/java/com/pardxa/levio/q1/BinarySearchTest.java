...
public class BinarySearchTest {
    ...
    void test() {
        ...
        assertEquals(-1, BinarySearch.search(-100, list));
        ...
        assertEquals(3, BinarySearch.search(8, list));
        assertEquals(-3, BinarySearch.search(5, list));
        assertEquals(-8, BinarySearch.search(15, list));
        assertEquals(-8, BinarySearch.search(23, list));
